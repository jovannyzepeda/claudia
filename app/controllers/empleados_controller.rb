class EmpleadosController < ApplicationController
  ...
  def create
    ...
    @empleado.store_id = @tienda.id
    respond_to do |format|
      if @empleado.save
        format.html { redirect_to @tienda, notice: 'Empleado registrado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @empleado.update(empleado_params)
        format.html { redirect_to @tienda, notice: 'Empleado actualizado correctamente.' }
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:nombre, :direccion, :telefono, :nacimiento, :puesto, :foto)
    end
end
